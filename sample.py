...
if __name__=='__main__':
    ...
    JSON_outputfile = os.path.join(os.getcwd(),'tests/output/LI/'+filename)
    ...
    print(f"output: {JSON_outputfile}")
    print(f"input: {PBF_inputfile}")
    ...
    [Data,Elements]=run_filter(elementname, 
                               PBF_inputfile, 
                               JSON_outputfile, 
    ...
    # print(type(Elements[elementname]), len(Elements[elementname]))

    
    # print(CC.Cyan+'Elements:'+CC.End)
    # print(Elements)
    #At this point we could export the elements to a geojson-file
    export_geojson(Elements[elementname]['Way'],Data,filename='./tests/output/LI/test.geojson',jsontype='Line')
